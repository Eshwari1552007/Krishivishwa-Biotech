...
const images = [
  {
    ...
    description:
      'Biofertilizers are eco-friendly inputs containing beneficial microorganisms that naturally improve soil fertility by fixing nitrogen, solubilizing phosphorus, and promoting plant growth.',
  },
  {
    src: img2,
    ...
    description:
      'Fungicides help protect crops from harmful fungal infections like mildew, rust, and blight, ensuring healthy plants and maximizing yield throughout the growing season.',
  },
  {
    src: img3,
    ...
    description:
      'Insecticides target and eliminate damaging insects that attack crops, safeguarding agricultural output while minimizing plant stress and crop loss.',
  },
  {
    src: img4,
    ...
    description:
      'Nematicides are specialized products designed to manage soil-borne nematodes that damage plant roots, ensuring robust root systems and healthier crop development.',
  },
];
      ...
      <div className="image-slider">
        ...
        <div className="slider-overlay">
          <div key={selectedCard.title} className="text-content animate" data-aos="fade-up" data-aos-delay="200">
            ...
            <button className="see-more"  data-aos="zoom-in" data-aos-delay="400"> <i className="bi bi-cart-fill"></i>Shop Now</button>
          </div>
