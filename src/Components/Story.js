...
import TransparentLogo from '../Assets/Images/kvt.png';
    ...
    <div className="mobile-text-slide">
      ...
      <div style={{ overflowX: 'hidden' }}>
        <div className="testimonial container" data-aos="fade-up">
          <blockquote>
            “Krishivishwa’s microbial solutions helped us grow healthier crops with less input!”
          </blockquote>
          <p>— A Progressive Farmer from Nashik</p>
        </div>
      </div>
    </div>
  );
